...
import { Vote, Music, Users, Smartphone, Zap, Shield, BarChart3, Settings, Heart, Headphones, Radio, Crown } from "lucide-react";
...
const FeaturesGrid = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Customize time limits, content filters, automatic duplicate removal and many other configuration options.",
      color: "#a171f8",
      badge: "Pro",
    },
    {
      ...
      description: "Save the best playlists from your events. Reuse them or share with friends as inspiration.",
      color: "#87e5dd",
      badge: "Social",
    },
    {
      icon: Headphones,
      title: "Track Preview",
      description: "30-second track previews before voting. Guests can listen to a snippet before making decisions.",
      color: "#a171f8",
      badge: "Preview",
    },
    {
      icon: Radio,
      title: "DJ Mode",
      description: "Special mode for DJs with additional controls, priority queue and instant switching capabilities.",
      color: "#87e5dd",
      badge: "DJ Mode",
    },
    {
      icon: Crown,
      title: "VIP Votes",
      description: "Give some guests higher vote weight. Perfect for organizers, VIPs or event sponsors.",
      color: "#a171f8",
      badge: "Premium",
    },
  ];
      ...
      <Container>
        ...
        <FadeInSection>
          <div className="text-center mb-16">
            ...
            <Typography className="text-[#bdf6f2] text-lg md:text-xl max-w-3xl mx-auto">Complete toolkit for creating perfect musical experiences at your events</Typography>
          </div>
        </FadeInSection>
        ...
        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              <Card className="h-full backdrop-blur-xl bg-[rgba(32,36,58,0.92)] rounded-2xl border-2 border-[rgba(135,229,221,0.2)] hover:border-[rgba(135,229,221,0.4)] transition-all duration-300 hover:shadow-[0_8px_32px_rgba(135,229,221,0.15)] group">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <Badge variant="outline" className="text-xs font-medium border-[rgba(135,229,221,0.3)] text-[#87e5dd] bg-[rgba(135,229,221,0.1)]">
                      {feature.badge}
                    </Badge>
                  </div>

                  {/* Title */}
                  <Typography variant="h6" className="font-bold text-[#e2f2fa] mb-3 group-hover:text-[#87e5dd] transition-colors duration-300">
                    {feature.title}
                  </Typography>

                  {/* Description */}
                  <Typography className="text-[#bdf6f2] text-sm leading-relaxed">{feature.description}</Typography>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }} viewport={{ once: true }} className="mt-16 text-center">
            <Card className="backdrop-blur-xl bg-gradient-to-r from-[rgba(135,229,221,0.1)] to-[rgba(161,113,248,0.1)] rounded-3xl border-2 border-[#87e5dd]/30 p-8 max-w-2xl mx-auto">
              <CardContent className="p-0">
                ...
                <Typography className="text-[#bdf6f2] mb-6">You don't need multiple apps. Track Drop has everything needed to create the perfect musical experience.</Typography>
