...
import { getCurrentUser, getJoinedPlaylists, getPlaylistData, leavePlaylist } from "@/lib/actions";
...
import {
    Info as PlaylistInfoIcon,
    LogOut as LeavePlaylistIcon,
    MoreVertical as MenuVertButtonIcon,
            ...
            <Dialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Leaving this playlist will remove all your placed votes and added songs. Are
                            you sure you want to proceed?</DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
