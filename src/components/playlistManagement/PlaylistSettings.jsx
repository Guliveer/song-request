...
import { Trash2 as DeleteIcon, User as ProfileIcon } from "lucide-react";
        ...
        <div className="p-6">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <Textarea id="playlist-description" rows={4} value={tempDescription}
            ...
            <div className="flex flex-col gap-6 mt-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Input id="moderator-username" value={username} onChange={(e) => setUsername(e.target.value)}
                               className="flex-1"/>
                ...
                {moderatorList.length > 0 && (
                    <div
                        className="max-h-48 overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-lg bg-background p-2">
                        {moderatorList.map((mod) => (
                            <div key={mod.id}
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button variant="ghost" size="sm" onClick={() => handleRemoveModerator(mod.id)}
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Are you sure you want to delete this playlist? This action cannot be
