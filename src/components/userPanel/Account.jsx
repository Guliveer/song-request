...
import { Edit, Palette, Smile, User, X } from "lucide-react";
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            ...
            const {
                data,
                error
            } = await supabase.from("users").select("username, color, emoji").eq("id", user.user.id).single();
        ...
        <>
                        ...
                        <div>
                            ...
                            <div className="flex items-center mt-1">
                                <Typography variant="body2"
                                            className={`${pendingChanges.username ? "text-[#8FE6D5]" : "text-gray-400"}`}>
                        ...
                        <div>
                            ...
                            <div className="flex items-center mt-1">
                                <div className="w-6 h-6 rounded-full border border-gray-600"
                                     style={{backgroundColor: pendingChanges.color || avatarColor}}/>
                ...
                <div className="flex items-center justify-between py-3">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <div className="flex items-center mt-1">
                                <Typography variant="body2"
                                            className={`${pendingChanges.emoji ? "text-[#8FE6D5]" : "text-white"}`}>
            ...
            <div className="mt-6 flex justify-end">
                <Button onClick={handleGlobalSave}
                        ...
                        className="bg-[#8FE6D5] text-black hover:bg-[#6fc3b2]">
                    Save All Changes
                </Button>
            </div>
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="flex flex-row gap-4 justify-center items-center p-4">
                        ...
                        <div className="w-24 h-24 rounded-full border border-gray-600 flex items-center justify-center"
                            ...
                            {(pendingChanges.emoji !== null ? pendingChanges.emoji : avatarEmoji) && <span
                                className="text-4xl">{pendingChanges.emoji !== null ? pendingChanges.emoji : avatarEmoji}</span>}
                        </div>
                    </div>
                    <DialogFooter>
            ...
            <Dialog open={openDialog} onOpenChange={setOpenDialog}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleSaveUsernameToCache} disabled={!tempUsername.trim()}
                                className={`${tempUsername.trim() ? "text-[#8FE6D5] hover:bg-[#8FE6D5]/10" : "text-gray-400"}`}>
                            Save
                        </Button>
                    </DialogFooter>
                </DialogContent>
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4">
                        <div className="flex flex-col items-center">
                            ...
                            <div
                                className="w-16 h-16 rounded-full border border-gray-600 flex items-center justify-center mb-4"
                                style={{backgroundColor: pendingChanges.color || avatarColor}}>
                    ...
                    <DialogFooter className="flex justify-between">
                        <Button variant="destructive" onClick={handleRemoveEmojiFromCache}
                        ...
                        <div className="space-x-2">
                            ...
                            <Button onClick={handleSaveEmojiToCache} disabled={!tempEmoji}
                                    className={`${tempEmoji ? "hover:bg-[#8FE6D5]/10" : ""}`}>
                                Save
                            </Button>
                        </div>
                    </DialogFooter>
            ...
            <Button variant="outline" className="text-[#8FE6D5] border-[#8FE6D5] hover:bg-[#8FE6D5]/10 mt-4"
            ...
            <Dialog open={disable2faDialogOpen} onOpenChange={setDisable2faDialogOpen}>
                <DialogContent className="sm:max-w-xs">
                    ...
                    <div className="space-y-4">
                        <Typography className="mb-4">To disable 2FA, enter the current code from your Authenticator
                            app.</Typography>
                        <Input placeholder="6-digit code" value={disable2faCode}
                               onChange={(e) => setDisable2faCode(e.target.value)} maxLength={6}
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <Typography variant="body2" className="text-gray-300">
                            Use apps like <strong>Google Authenticator</strong>, <strong>Authy</strong> or <strong>Microsoft
                            Authenticator</strong>. If you can't scan, you can manually enter the code shown below.
                        </Typography>
                        ...
                        {qrCode && (
                            <>
                                ...
                                <div className="flex justify-center">
                                    <img src={qrCode} alt="QR code" width={220} height={220}
                        ...
                        {totpSecret && (
                            <div className="flex justify-center w-full">
                                <div
                                    className="mt-4 mb-2 px-6 py-4 bg-gray-800 rounded-lg border border-gray-700 flex flex-col items-center shadow-lg max-w-sm mx-auto text-center">
                                    <Typography variant="subtitle2"
                                                className="text-[#8FE6D5] font-bold tracking-wide mb-2">
                                        Manual setup code
                                    </Typography>
                                    <Typography variant="body1"
                                                className="text-white font-mono text-lg tracking-wider break-all mb-2 text-center bg-gray-900 px-4 py-2 rounded shadow-inner"
                                                title={totpSecret}>
                                        {totpSecret}
                                    </Typography>
                                    <Typography variant="caption" className="text-gray-400 text-center">
                                        If you can't scan the QR code, copy and enter this code manually in your
                                        authenticator app.
                                    </Typography>
                                </div>
                            </div>
                        ...
                        <Input placeholder="6-digit code" value={verifyCode}
                               onChange={(e) => setVerifyCode(e.target.value)}
                               className="text-center tracking-widest font-semibold text-lg" autoFocus maxLength={6}/>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleVerifyMfa} disabled={!verifyCode || !factorId}
                                className="bg-[#8FE6D5] text-black font-bold hover:bg-[#6fd1b5]">
                            Enable 2FA
                        </Button>
                    </DialogFooter>
                </DialogContent>
            ...
            <Dialog open={showPasswordDialog} onOpenChange={setShowPasswordDialog}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <Input placeholder="Repeat new password" type="password" value={repeatPassword}
